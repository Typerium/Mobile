...
const Input = ({
  value, label, labelSecond, isDisabled, onChangeText, style, styleInput,
    ...
    <View style={[styles.container, style]}>
      ...
      >
        ...
        <TextInput
          ...
          style={[styles.input, styleInput, { backgroundColor, color }]}
          placeholder={label}
      ...
      <TouchableOpacity style={styles.iconContainer} onPress={handlePressIcon}>
        ...
        {error && !isSecureText ? <IncorrectIcon height={13} width={13} /> : null }
      </TouchableOpacity>
      {/* top label */}
      {/* // $FlowFixMe */}
      <LinearGradient
